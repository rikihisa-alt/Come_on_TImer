...
export const DEFAULT_SOUND: SoundSettings = {
  ...
  blindChangeSoundId: 'chime-short',
  breakStartEnabled: true,
  breakStartSoundId: 'fanfare-long',
  oneMinWarningEnabled: true,
  oneMinWarningSoundId: 'beep-short',
  threeMinThirtyWarningEnabled: false,
  threeMinThirtySoundId: 'bell-short',
  ttsEnabled: false,
  ttsLang: 'ja',
