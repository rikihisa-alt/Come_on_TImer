  ...
  return (
    <div className="min-h-screen p-4 md:p-8">
      <div className="max-w-lg mx-auto pt-2">
        <h1 className="text-2xl font-bold text-white mb-6">アカウント設定</h1>
        ...
        <div className="space-y-3">
          ...
          {/* Employee management link (owner only) */}
          {profile?.role === 'owner' && (
            <Link href="/app/users" className="g-card p-4 md:p-5 flex items-center justify-between group hover:border-blue-500/20 transition-colors">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-lg bg-blue-500/10 flex items-center justify-center">
                  <svg className="w-4.5 h-4.5 text-blue-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                  </svg>
                </div>
                <div>
                  <p className="text-white font-medium text-sm">従業員管理</p>
                  <p className="text-white/30 text-xs mt-0.5">追加・削除・パスワードリセット</p>
                </div>
              </div>
              <svg className="w-5 h-5 text-white/15 group-hover:text-blue-400/50 transition-colors" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
