  ...
  return (
    <nav className="g-topbar flex items-center justify-between px-3 md:px-5 py-2 md:py-3 border-b border-white/[0.06] sticky top-0 z-50">
      <Link href="/" className="flex items-center gap-1.5 md:gap-2 group shrink-0">
        <span className="text-base md:text-lg font-black text-blue-400 tracking-tight group-hover:text-blue-300 transition-colors">COME ON</span>
        <span className="text-white/25 font-medium text-xs md:text-sm">Timer</span>
      </Link>
